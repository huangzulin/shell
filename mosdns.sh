...
mosdns_download_url=https://download.fastgit.org/IrineSistiana/mosdns-cn/releases/latest/download/mosdns-cn-linux-$arch.zip
...
wget -O /root/mosdns/geoip.dat https://download.fastgit.org/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat
wget -O /root/mosdns/geosite.dat https://download.fastgit.org/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat
